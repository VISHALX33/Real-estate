...
const Contact = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} pb-20 `}>
      <section id='contact' className={`${darkMode ? 'dark bg-gray-800' : 'light bg-red-100'} pb-20 lg:w-[95%] w-full h-fit m-auto rounded-xl grid grid-cols-1 lg:grid-cols-2 justify-center items-center lg:px-36 px-6 py-20 gap-10 `} >
        <div data-aos='zoom-in' className=' bg-white dark:bg-blackvp-10 flex flex-col justify-center p-10 items-start gap-4 rounded-xl '>
          <h1 className='text-2xl text-black font-semibold dark:text-white' >Send us a message today</h1>
          <input type="text" placeholder='Enter your full name here' className='w-full px-6 py-3 border-b-2 border-gray-200 rounded-xl ' />
          <input type="email" placeholder='Enter your valid email' className='w-full px-6 py-3 border-b-2 border-gray-200 rounded-xl ' />
          <input type="number" placeholder='Enter your full valid mobile number' className='w-full px-6 py-3 border-b-2 border-gray-200 rounded-xl ' />
          <textarea name="" id="" cols="30" rows="5" placeholder='Enter your message here.....' className='w-full px-6 py-3 border-b-2 border-gray-200 rounded-xl'></textarea>
